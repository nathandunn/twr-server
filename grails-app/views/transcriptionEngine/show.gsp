...
<html>
	...
	<body>
		<a href="#show-transcriptionEngine" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="show-transcriptionEngine" class="content scaffold-show" role="main">
			...
			<g:form url="[resource:transcriptionEngineInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${transcriptionEngineInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
