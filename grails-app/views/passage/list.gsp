...
<body>
<a href="#list-passage" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="externalId"
                              title="${message(code: 'passage.externalId.label', default: 'External Id')}"/>
        ...
        <g:each in="${passageInstanceList}" status="i" var="passageInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show"
                            id="${passageInstance.id}">${fieldValue(bean: passageInstance, field: "externalId")}</g:link></td>
