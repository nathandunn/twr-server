	...
	<body>
		...
		<div id="show-patch" class="content scaffold-show" role="main">
			...
			<ol class="property-list patch">
				...
				<g:if test="${patchInstance?.appliedDate}">
				<li class="fieldcontain">
					<span id="appliedDate-label" class="property-label"><g:message code="patch.appliedDate.label" default="Applied Date" /></span>
					
						<span class="property-value" aria-labelledby="appliedDate-label"><g:formatDate date="${patchInstance?.appliedDate}" /></span>
