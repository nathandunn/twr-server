...
<body>
<a href="#show-humanTranscript" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="show-humanTranscript" class="content scaffold-show" role="main">
    ...
    <ol class="property-list humanTranscript">
        ...
        <li class="fieldcontain">
            <span id="audioFile-label" class="property-label"><g:message code="humanTranscript.audioFile.label"
                                                                         default="Audio File"/></span>

            <span class="property-value" aria-labelledby="audioFile-label"><g:link controller="audioFile" action="show"
                                                                                   id="${humanTranscriptInstance?.audioFile?.id}">${humanTranscriptInstance?.audioFile?.fileName}</g:link></span>
        ...
        <li class="fieldcontain">
            <span id="processDate-label" class="property-label"><g:message code="humanTranscript.processDate.label"
                                                                           default="Process Date"/></span>
        ...
        <li class="fieldcontain">
            <span id="status-label" class="property-label"><g:message code="humanTranscript.status.label"
                                                                      default="Status"/></span>
    ...
    <g:form url="[resource: humanTranscriptInstance, action: 'delete']" method="DELETE">
        <fieldset class="buttons">
            <g:link class="edit" action="edit" resource="${humanTranscriptInstance}"><g:message
